...
public class MicroBankDaoService {
    ...
    private String URL = "jdbc:mysql://localhost:3306/micro_finance?user=root&password=password";
    ...
    public boolean addMicroBankBalance(int groupId) {
        ...
        try (Connection conn = DriverManager.getConnection(URL); PreparedStatement prestmt = conn.prepareStatement(microMicroBankBalanceSql);) {
